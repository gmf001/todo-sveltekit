<script>
	import ProgressSection from '../components/progress/ProgressSection.svelte';
	import AddTodo from '../components/todo/AddTodo.svelte';
	import TodoList from '../components/todo/TodoList.svelte';
</script>

<main class="min-h-screen bg-olive-one p-0 selection:bg-green-two md:py-24 md:px-8">
	<div
